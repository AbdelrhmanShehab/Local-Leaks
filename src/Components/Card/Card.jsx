                ...
                <div className={style.productDetails}>
                    ...
                    <div className={style.colorOptions}>
                        {colors.map((color, index) => (
                            <span
                                key={index}
                                className={`${style.colorDot} ${selectedColor === color ? style.colorDotSelected : ''}`} // Add the selected class if color matches
