...
//             // If the option is already selected, remove it from the array, else add it
//             if (prev.includes(option)) {
//                 return prev.filter((item) => item !== option); // Remove from the array
//             }
//             return [...prev, option]; // Add to the array
//         });
//     };
...
//                                 onChange={() => handleCheckboxChange(value)} // Handle selection change
//                             />
//                         </li>
//                     ))}
//                 </ul>
