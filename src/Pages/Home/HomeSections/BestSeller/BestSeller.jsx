...
const BestSellerItems = [
  {
    ...
    price: "750",
    description:
      "A contemporary design crafted to catch attention while still blending in with the crowd. Super comfy and lightweight makes it perfect for any occasion.",
  },
  {
    id: 1002,
    title: "SweatShirt",
    ...
    price: "450",
    description:
      "A stylish piece that effortlessly combines modern aesthetics with timeless appeal. Crafted with comfort in mind, this item offers a lightweight feel that’s perfect for any season.",
  },
];
      ...
      <div className={style.bestSellerContainer}>
        <div className={style.bestSellerImgaes}>
          ...
          <div className={style.leftImages}>
            <img
              src={BestSellerItems[currentIndex].imgs[0]}
              alt="BestSeller 1"
              className={style.firstImg}
            />
            <img
              src={BestSellerItems[currentIndex].imgs[1]}
              alt="BestSeller 2"
          ...
          <div className={style.rightContent}>
            <img
              src={BestSellerItems[currentIndex].imgs[2]}
              alt="BestSeller 3"
              className={style.thirdImg}
            />
            {/* Pagination Dots */}
