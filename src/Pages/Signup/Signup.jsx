...
import { TextBox, GoogleButton, BigButton, AuthenticationBanner, InputSelect, DropdownInput } from '../../Components/ReusableComponents/ReusableComponents';
...
const Signup = () => {
    ...
    const days = Array.from({ length: 31 }, (_, i) => ({ value: i + 1, label: (i + 1).toString().padStart(2, "0") }));
    const months = [
        { value: 1, label: "Jan" },
        { value: 2, label: "Feb" },
        { value: 3, label: "Mar" },
    ...
    const years = Array.from({ length: 124 }, (_, i) => ({ value: 2023 - i, label: `${2023 - i}` })); // From 2023 to 1900

    // Check if all required fields are filled
    const isFormValid = selectedGender && selectedStyle && selectedDay && selectedMonth && selectedYear;
        ...
        <>
            ...
            {!showMoreInfo ? (
                <main className={style.signup}>
                    ...
                    <section className={style.rightSection}>
                        ...
                        <form className={style.signupForm} onSubmit={handleSignupSubmit}>
                            ...
                            <p className={style.signupFormDescription}>Enter your credentials to create your account.</p>
                ...
                <div className={style.moreInfoSection}>
                    ...
                    <p className={style.moreInfoDescription}>For a better experience, let us know more about you.</p>
